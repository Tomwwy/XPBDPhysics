...
// swapped them. Convex-convex cells will route through a shared GJK/EPA cell
// (gjk.hpp) rather than a bespoke function. The contact is the canonical output
// of every cell; unimplemented cells return a non-touching Contact so partial
// shape support is always safe.
